	...
	*/
	...
	private function cargar_perfiles_produccion()
	{
		...
		if (isset($restricciones) && ! empty($restricciones)) {
		 ...
		 //-- Si hay menues las agrego al ppio.
		if (isset($menues) && ! empty($menues)) {
			$archivos = array_merge($menues, $archivos);
		}		
