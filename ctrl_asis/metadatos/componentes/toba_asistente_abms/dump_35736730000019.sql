------------------------------------------------------------
--[35736730000019]--  Comisión de Servicio 
------------------------------------------------------------
...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	'ctrl_asis', --proyecto
	'35736730000019', --molde
	'10', --operacion_tipo
	'Comisión de Servicio', --nombre
	'35736730000048', --item
	'comision_de_servicio', --carpeta_archivos
	'_comision_de_servicio', --prefijo_clases
	'ctrl_asis', --fuente
...
FROM
	comision as t_c
ORDER BY catedra', --cuadro_carga_sql
