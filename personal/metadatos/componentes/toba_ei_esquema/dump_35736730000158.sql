------------------------------------------------------------
--[35736730000158]--  ci_catedra - cons_car_cat - ci_esq_cargo - esquema 
------------------------------------------------------------
...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, punto_montaje, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'ci_catedra - cons_car_cat - ci_esq_cargo - esquema', --nombre
	NULL, --titulo
	'0', --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_esquema (objeto_esquema_proyecto, objeto_esquema, parser, descripcion, dot, debug, formato, modelo_ejecucion, modelo_ejecucion_cache, tipo_incrustacion, ancho, alto, dirigido, sql) VALUES (
	'personal', --objeto_esquema_proyecto
	'35736730000158', --objeto_esquema
	NULL, --parser
	NULL, --descripcion
	NULL, --dot
	NULL, --debug
